...
export class AdminusersComponent implements OnInit, OnDestroy {
  ...
  getData() {
    ...
    this.querySubscription = this._backendService.getProducts('users')
        .subscribe(members => {
  ...
  getFilterData(filters) {
    this.dataLoading = true;
    this.querySubscription = this._backendService.getFilterProducts('users', filters)
        .subscribe(members => {
          this.members = members;
          this.dataSource = new MatTableDataSource(members);
          this.dataSource.paginator = this.paginator;
...
getDoc(docId) {
  this.dataLoading = true;
  this.querySubscription = this._backendService.getOneProductDoc('users', docId)
      .subscribe(res => {
        if (res) {
          this.myDocData = res;
